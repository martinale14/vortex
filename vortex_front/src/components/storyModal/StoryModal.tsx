        ...
        <div className={styles.vortex_background}>
            <div className={styles.vortex_cardStory}>
                ...
                <div className={styles.vortex_cardStory_body}>
                    <Input className={styles.vortex_input_left} type='text' placeholder='Título' label='Título *' onChange={(e : any) => {setTitle(e.target.value)}}/>
                    <Input className={styles.vortex_input_left} type='text' placeholder='Empresa' label='Empresa' onChange={(e : any) => {setCompanyId(e.target.value)}}/>
                    <Input className={styles.vortex_input_left} type='text' placeholder='Sprint ##' label='Sprint' onChange={(e : any) => {setTitle(e.target.value)}}/>
                    <Input 
                    ...
                    <div className={styles.vortex_acc} >
                        <Input 
                            ...
                            onChange={(e : any) => {setAccDesc(e.target.value)}}
                            inputStyle={styles.vortex_input_desc}
                            textArea
                        />
                    </div>
                ...
                <div className={styles.vortex_button_save}>
                    <Button text='Guardar' onClick={ () => {
                        fetch(CREATE_SPRINT, {method:'POST', headers: HEADERS, body:JSON.stringify({
                                status: "open",
                                isEpic: false,
                                createdBy: user.id,
                                projectId: 2,
